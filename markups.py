...
<i>На вопрос можно ответить повторно! Вопросы, на которые Вы ответили будут с указанием ответа ниже вопроса!
Переходить на следующий вопрос можно только, если ответили на все предыдущие!
</i>
        '''
